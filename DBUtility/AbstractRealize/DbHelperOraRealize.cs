...
namespace DBUtility.AbstractRealize
{
    ...
    /// 可以用户可以修改满足自己项目的需要。
    /// </summary>
    public class DbHelperOraRealize : BaseDbHelper
    {
        //数据库连接字符串(web.config来配置)，多数据库可使用DbHelperSQLP来实现.
        //public string connectionString = PubConstant.ConnectionString;

        public DbHelperOraRealize()
        {
        ...
        public override bool Exists(string strSql, params DbParameter[] cmdParms)
        {
            cmdParms = (OracleParameter[])cmdParms;
        ...
        public override int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            using (OracleConnection conn = new OracleConnection(_connectionString))
            {
                ...
                try
                {
                    ...
                    DBUtility.AbstractRealize.DbHelperSQLRealize dbHelperSQL = new DbHelperSQLRealize(_connectionString);
                    int res = dbHelperSQL.ExecuteSqlTran(oracleCmdSqlList);
                    if (res <= 0)
                    {
                        tx.Rollback();
        ...
        public override int ExecuteSql(string SQLString, string content)
        {
            using (OracleConnection connection = new OracleConnection(_connectionString))
            {
                ...
                OracleParameter myParameter = new OracleParameter("@content", OracleDbType.NClob);
        ...
        public override int ExecuteSqlInsertImg(string strSQL, byte[] fs)
        {
            using (OracleConnection connection = new OracleConnection(_connectionString))
            {
                ...
                OracleParameter myParameter = new OracleParameter("@fs", OracleDbType.BFile);
        ...
        protected override DbDataReader ExecuteReader1(string strSQL)
        {
            ...
            try
            {
                ...
                return (OracleDataReader)myReader;
            }
            catch (System.Data.SqlClient.SqlException e)
            {
                throw e;
        ...
        {
            return (OracleDataReader)ExecuteReader1(strSQL);
        }
        /// <summary>
        /// 执行查询语句，返回DataSet
        /// </summary>
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public override int ExecuteSql(string SQLString, params DbParameter[] cmdParms)
        {
            OracleParameter[] cmdParms_change = ConvertParameters(cmdParms);
            using (OracleConnection connection = new OracleConnection(_connectionString))
            {
                using (OracleCommand cmd = new OracleCommand())
                {
                    try
                    {
                        PrepareCommand(cmd, connection, null, SQLString, cmdParms_change);
                        int rows = cmd.ExecuteNonQuery();
                        cmd.Parameters.Clear();
                        return rows;
                    }
        ...
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public override object GetSingle(string SQLString, params DbParameter[] cmdParms)
        {
            OracleParameter[] cmdParms_change = ConvertParameters(cmdParms);
            using (OracleConnection connection = new OracleConnection(_connectionString))
            {
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>OracleDataReader</returns>
        protected override DbDataReader ExecuteReader1(string SQLString, params DbParameter[] cmdParms)
        {
            OracleParameter[] cmdParms_change = ConvertParameters(cmdParms);
            OracleConnection connection = new OracleConnection(_connectionString);
            OracleCommand cmd = new OracleCommand();
        ...
        public OracleDataReader ExecuteReader(string SQLString, params DbParameter[] cmdParms)
        {
            return (OracleDataReader)ExecuteReader1(SQLString, cmdParms);
        }
        /// <summary>
        /// 执行查询语句，返回DataSet
        /// </summary>
        ...
        /// <returns>OracleDataReader</returns>
        protected override DbDataReader RunProcedure1(string storedProcName, IDataParameter[] parameters)
        {
            OracleConnection connection = new OracleConnection(_connectionString);
            OracleDataReader returnReader;
            connection.Open();
            OracleCommand command = (OracleCommand)BuildQueryCommand(connection, storedProcName, parameters);
            command.CommandType = CommandType.StoredProcedure;
            returnReader = command.ExecuteReader(CommandBehavior.CloseConnection);
            return (OracleDataReader)returnReader;

        }
        public OracleDataReader RunProcedure(string storedProcName, IDataParameter[] parameters)
        {
            return (OracleDataReader)RunProcedure1(storedProcName, parameters);
        }
        ...
        public override DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            using (OracleConnection connection = new OracleConnection(_connectionString))
            {
                ...
                sqlDA.SelectCommand = (OracleCommand)BuildQueryCommand(connection, storedProcName, parameters);
        ...
        private DbCommand BuildQueryCommand(OracleConnection connection, string storedProcName, IDataParameter[] parameters)
        {
        ...
        #endregion
        private OracleParameter[] ConvertParameters(DbParameter[] commandParameters)
        {
