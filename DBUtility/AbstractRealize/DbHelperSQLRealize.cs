...
namespace DBUtility.AbstractRealize
{
    ...
    /// </summary>
    public class DbHelperSQLRealize : BaseDbHelper
    {
        //数据库连接字符串(web.config来配置)，多数据库可使用DbHelperSQLP来实现.
        //public string connectionString = null ;

        public DbHelperSQLRealize(string strConn)
        {
        ...
        {
            cmdParms = (SqlParameter[])cmdParms;
        ...
        public override int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                try
                {
                    ...
                    DBUtility.AbstractRealize.DbHelperOraRealize dbHelperOra = new DBUtility.AbstractRealize.DbHelperOraRealize();
        ...
        {
            return (SqlDataReader)ExecuteReader1(strSQL);
        }
        /// <summary>
        /// 执行查询语句，返回DataSet
        /// </summary>
        ...
        {
            //
            SqlParameter[] cmdParms_change = ConvertParameters(cmdParms);
            using (SqlConnection connection = new SqlConnection(_connectionString))
            {
        ...
        public SqlDataReader ExecuteReader(string SQLString, params DbParameter[] cmdParms)
        {
            return (SqlDataReader)ExecuteReader1(SQLString, cmdParms);
        }
        /// <summary>
        /// 执行查询语句，返回DataSet
        /// </summary>
        ...
        {
            return (SqlDataReader)RunProcedure1(storedProcName, parameters);
        }
        ...
        private SqlParameter[] ConvertParameters(DbParameter[] commandParameters)
        {
